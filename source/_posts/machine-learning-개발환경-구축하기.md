---
title: Data science를 위한 개발환경 구축
...
Intro
---
대부분 처음 data science를 하고자 마음먹고 시도하는 것이 개발환경을 만드는 것 입니다.
...
---
우선 [Miniconda](https://docs.conda.io/en/latest/miniconda.html) 홈페이지를 가면 설치가 가능합니다.
